...
const MainBorrowedBookPages = () => {
  ...
  return (
    <div
      className={
        (window.location.pathname === "/admin/borrowedbooks/add-borrowedbook" &&
        WindowWidth <= 1000
          ? "h-[2000px]"
          : window.location.pathname ===
                "/admin/borrowedbooks/add-borrowedbook" && WindowWidth > 1000
            ? "h-[800px]"
            : window.location.pathname.startsWith(
                  "/admin/borrowedbooks/update-borrowedbook"
                ) && WindowWidth <= 1000
              ? "h-[2400px] mb-5"
              : window.location.pathname.startsWith(
                    "/admin/borrowedbooks/update-borrowedbook"
                ...
                ? "h-[1400px] mb-5"
                : window.location.pathname === "/admin/borrowedbooks"
                  ? "h-fit"
      ...
      >
        <div className="w-full flex justify-center items-center">
          <button
            ...
            onClick={() => window.location.assign("/admin/borrowedbooks")}
          >
            show all borrowedbooks
          </button>
        </div>
        <div className="w-full flex justify-center items-center">
          <button
            ...
            onClick={() =>
              window.location.assign("/admin/borrowedbooks/add-borrowedbook")
            }
          >
            add borrowedbook
          </button>
...
export default MainBorrowedBookPages;
